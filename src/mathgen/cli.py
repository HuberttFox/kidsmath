...
def _parse_argv(argv: list[str] | None) -> argparse.Namespace:
    ...
    gen.add_argument("--left-factor-range", default=None, help="第一个因数范围，如 10-99（a × b 中 a）")
    gen.add_argument("--right-factor-range", default=None, help="第二个因数范围，如 2-9（a × b 中 b）")
